...
class HeartRate:
    ...
    def plotHeartRate(data):
        ...
        print(id)
        print(heartRate)
        plt.plot(id,heartRate, color = "#0096FF")
...
class BloodPressure:
    ...
    def plotbloodPressure(data):
        ...
        plt.plot(id,systolic_data, color = "#5800FF", label = "Systolic")
        plt.plot(id,diastolic_data, color = "#00D7FF", label = "Diastolic")
        plt.legend()
...
class BloodSugar:
    ...
    def plotbloodSugar(data):
        ...
        plt.plot(id,blood_sugar_mmol_l, color = "#5800FF", label = "mM")
